...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary fixed-top">
        <div class="<?= ($page == "admin" || $page == "admin.add") ? 'container-fluid' : 'container'; ?>">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item <?= ($page === 'account') ? 'active' :''; ?>">
                        <a class='nav-link' href="?page=account"><i class="fas fa-book-open"></i> Mon autre catalogue</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <!-- <li class="nav-item <?= ($page === 'account') ? 'active' :''; ?>">
    ...
    <main class="<?= ($page === 'admin') ? 'container-fluid' : 'container'; ?>">
        <?= $content; ?>
    </main>
